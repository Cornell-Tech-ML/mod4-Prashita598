...
class Module:
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        """Collects all the parameters of this module and its descendents.

        Returns
        -------
            The name and `Parameter` of each descendant parameter.
    ...
    def parameters(self) -> Sequence[Parameter]:
        """Enumerates over all the parameters of this module and its descendents."""
    ...
    def add_parameter(self, k: str, v: Any) -> Parameter:
        """Manually adds a parameter. Useful helper for scalar parameters.
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Calls the forward funcion with the given arguments and keyword arguments."""
